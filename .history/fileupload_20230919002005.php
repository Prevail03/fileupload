...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_FILES['file']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = 'INSERT INTO assetInventory (laptopID , name, laptopModel, laptopSN, yearofpurchase, valueOfPurchase, usegeStatus, whereItIs, insuranceStatus , currentOwner, statusOfMachine, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
        ...
        foreach ($worksheet->getRowIterator(2) as $row) {
            ...
            $params = [$laptopID, $currency, $dateFormatted, $description, $withdrawal, $deposit, $balance, $schemeCode, $createdAt, $selectedPeriods, $selectedSpecifications];
