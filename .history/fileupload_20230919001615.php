...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_FILES['file']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = 'INSERT INTO assetInventory (laptopID  , name, laptopModel, description, withdrawal, deposit, balance, schemeCode, createdAt, selectedPeriod, selectedPeriodSpecification) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
