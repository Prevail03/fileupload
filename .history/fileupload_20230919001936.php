...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($_FILES['file']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = 'INSERT INTO assetInventory (laptopID  , name, laptopModel, laptopSN, yearofpurchase, valueOfPurchase, usegeStatus, whereItIs, insuranceStatus , currentOwner, statusOfMachine) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
