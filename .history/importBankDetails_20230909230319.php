    ...
    if ($_FILES['file']['error'] === UPLOAD_ERR_OK) {
        ...
        if ($fileType === 'stanchartPdf') {
            try {
                ...
                $sql = 'INSERT INTO BankTransactions ( currency, date, description, withdrawal, deposit, balance, schemeCode, createdAt, selectedPeriod, selectedPeriodSpecification) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? ,?)';
