  ...
  if ($_FILES['file']['error'] === UPLOAD_ERR_OK) {
    ...
    try {
        ...
        foreach ($worksheet->getRowIterator(2) as $row) {
          ...
          $params=array($bankDetailsID, $accountNumber, $accountName, $address, $currency, $dateFormatted, $description, $withdrawal, $deposit, $balance, $schemeCode, $createdAt, $selectedPeriods, $selectedSpecifications);
